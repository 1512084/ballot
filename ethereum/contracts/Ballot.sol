...
contract BallotFactory {
    ...
    function createBallot(bytes32[] proposalNames, uint[] proposalIndexs) public {
        address newBallot = new Ballot(proposalNames, msg.sender,proposalIndexs);
...
contract Ballot{ //Bỏ phiếu
    ...
    function Ballot(bytes32[] proposalNames, address creator, uint[] proposalIndexs) public{//Khởi tạo n đối tượng được bầu chọn
        chairperson = creator; // Chủ tịch hội đồng là người tạo ra cuộc bầu chọn
